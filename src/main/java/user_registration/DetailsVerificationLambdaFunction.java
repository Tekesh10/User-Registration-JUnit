...
public class DetailsVerificationLambdaFunction {
    public static void main(String[] args) {
        ...
        Verify.output(detailVerification,"^[A-Z][a-z]{2,}","khan");
        System.out.println("\nemail ID");
        Verify.output(detailVerification,"^[a-z0-9]+([.+_-]?[a-z0-9]+)?@[a-z0-9]+[.]([a-z0-9]+[.])?[a-z]{2,}","aman-khan@gmail.co1.in");
        Verify.output(detailVerification,"^[a-z0-9]+([.+_-]?[a-z0-9]+)?@[a-z0-9]+[.]([a-z0-9]+[.])?[a-z]{2,}","aman-khan@gmail.co.in1");
        System.out.println("\nPhone Number");
